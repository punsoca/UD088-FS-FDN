...
Add an 'Edit' and 'Delete' link for every restaurant entry.  The links won't have to do anything
so leave their href links blank.
...
class webServerHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        try:
            ...
            self.send_error(404, f"File Not Found {self.u}")
