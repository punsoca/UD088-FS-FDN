'''
Objective 5:  Process Delete Request

NOTE:  Just for fun, I added a Cancel button in case users change their mind
        ...
        try:  
            if self.path.endswith("/restaurants"):
                ...
                for restaurant in restaurants:
                    ...
                    message += f"<a href='/restaurants/{restaurant.id}/delete'>Delete</a>"         # pass the restaurant.id in the delete href 
                    message += "<br></br>"
            ...
            # Objective 5:  create a "/restaurants/<restaurant.id>/delete" page     
            if self.path.endswith("/delete"):
                ...
                # simple form 
                message += f"<h1>Are you sure you want to delete {resto.name}?</h1>"  # display restaurant name
                message += f"<form method='POST' enctype='multipart/form-data' action='/restaurants/{num}/delete'>>"
                message += "<input type='submit' value='Delete'> </form>"
                
                # add a Cancel button and link it to the restaurants list page
                message += "<a href='/restaurants'>Cancel</a>"
