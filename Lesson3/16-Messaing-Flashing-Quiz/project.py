...
def newMenuItem(restaurant_id):
    ...
    if request.method == 'POST':
        ...
        # add a flash "prompt" message when new item created successfully
...
def editMenuItem(restaurant_id, menu_id):
    ...
    if request.method == 'POST':
        ...
        # add a flash "prompt" message when edit operation is successful
...
def deleteMenuItem(restaurant_id, menu_id):
    ...
    if request.method == 'POST':
        ...
        # add a flash "prompt" message when delete operation is successful
...
if __name__ == '__main__':
    ...
    # to allow for flash messaging, an app.secret_key needs to be set up
